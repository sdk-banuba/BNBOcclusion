...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-146-g6f441498b/BNBOcclusion.zip",
            checksum: "fc0e55aa3e0abdc3a9bc4f908c9067118a8334a4e854c109d83ea9650dc22038"
        ),
        .target(
