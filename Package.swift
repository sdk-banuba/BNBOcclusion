...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-184-gfc3672a53b/BNBOcclusion.zip",
            checksum: "58a072724fca67c16ed8146143eeffcc58031581cf20f069728c4d97252f1e06"
        ),
        .target(
