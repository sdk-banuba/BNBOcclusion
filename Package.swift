...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-124-gbdb47c5e3/BNBOcclusion.zip",
            checksum: "b1b7a957a525bae433a5efbf769d53b171f30c0e76e3997ce7cdf623e5c79275"
        ),
        .target(
