...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-184-gd8cb662170/BNBOcclusion.zip",
            checksum: "b4425d757298b29a824a0517776e7b27f195d5d76429e32fe8f71c6e6bd936f0"
        ),
        .target(
