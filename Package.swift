...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-136-g6ec65980f/BNBOcclusion.zip",
            checksum: "9b604fbbbdeb71b5d39fed3276e1b0d57b3bf313e594395c6397221a9aa2e075"
        ),
        .target(
