...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.10.1-73-g8d138045c3/BNBOcclusion.zip",
            checksum: "d513b870524de3eb74790c49a465542cca24514e41c7a29c73d374d39f67982a"
        ),
        .target(
