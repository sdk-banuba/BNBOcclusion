...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-175-g35e1b614c0/BNBOcclusion.zip",
            checksum: "baab3b8f95772fc935cd41c4a43669aa85fc073060e6eb87ab1434c57b939809"
        ),
        .target(
