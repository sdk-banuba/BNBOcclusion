...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-137-gc11b2b754/BNBOcclusion.zip",
            checksum: "848969e808405f8e7fcb79422cc6100500a47d0deee44e5995e708ca6b358f94"
        ),
        .target(
