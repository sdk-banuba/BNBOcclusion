...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-150-gd7caecfaf/BNBOcclusion.zip",
            checksum: "21cb461b9497aef85f65a27c5de7433e263b3c1d6853f2d22d93e296739f81b8"
        ),
        .target(
