...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-132-g6a6b08380/BNBOcclusion.zip",
            checksum: "c548238bbcd69aa738a3b82fd0035d669c3e3741edebe84e11eff4707ae527ea"
        ),
        .target(
