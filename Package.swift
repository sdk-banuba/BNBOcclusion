...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-178-g3b9a032012/BNBOcclusion.zip",
            checksum: "0313b9e0fc28b6e31bb30593b246ad5beb76eb7009a7fefb4d6e73025f65e0c2"
        ),
        .target(
