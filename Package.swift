...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-170-g91aac4bda/BNBOcclusion.zip",
            checksum: "efebdea3a8a0413a47cd03977a37fd620e38a8a5178deea8821f7e3a66946778"
        ),
        .target(
