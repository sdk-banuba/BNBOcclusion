...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-188-g3e9bf00b67/BNBOcclusion.zip",
            checksum: "0d41cb217437f25e332804507bc893bd243a0d0e30031c010bc0bcd1b16778d8"
        ),
        .target(
