...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-219-gefae079ac3/BNBOcclusion.zip",
            checksum: "41a500223e4a6644d22f39270bf6061bde33d33a3caeb17a6d10f56576f1f5c8"
        ),
        .target(
