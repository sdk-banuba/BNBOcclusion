...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-173-gec24d1c86/BNBOcclusion.zip",
            checksum: "f990406d16b39c42b4c038e3f9e847a13d258b7235f7b5cc4c11e48447ba70ea"
        ),
        .target(
