...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-217-g36d3a95c51/BNBOcclusion.zip",
            checksum: "b5b409386d0ce36bb85449b1ee3bdb80b729f32c6eb379590d88b27df764b83d"
        ),
        .target(
