...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-147-gb1b24af02/BNBOcclusion.zip",
            checksum: "ef0ac8d18258e899db8f006a7a347e7989a0c9add0aec3f229a328b121fd70a4"
        ),
        .target(
