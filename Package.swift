...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-211-g9ce64ef1c2/BNBOcclusion.zip",
            checksum: "26192243fcfadcc8b61882bbd9f1caf64a30d7bd337b95aabe7b82e851824864"
        ),
        .target(
