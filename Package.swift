...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-178-gf86664003c/BNBOcclusion.zip",
            checksum: "17c1ac5fd42df47e4674b7c1bdead248096ea5f4ba123e07e3bf08c9c06a4109"
        ),
        .target(
