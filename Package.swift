...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-162-gcda6b9c4b/BNBOcclusion.zip",
            checksum: "f943082804b59de2a93c2cf2253f4bbdfa1b91e3130e2df87e9bcec4376663af"
        ),
        .target(
