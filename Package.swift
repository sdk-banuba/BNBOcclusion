...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-143-g50b5f987b/BNBOcclusion.zip",
            checksum: "7923aee956e6004b9eeae92ddd611f710b8cdd51bfd97d668350b51fe45e55f1"
        ),
        .target(
