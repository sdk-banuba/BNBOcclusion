...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-170-g93323bc96/BNBOcclusion.zip",
            checksum: "f162f5f0ad30f74b73ed413e97d8914240ad5b7773022220b29d568b2a5b44cd"
        ),
        .target(
