...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-174-gec051bdc7/BNBOcclusion.zip",
            checksum: "88a65f8360d09a1e6223b7076ef3dc3a99834c68b15af1d134d300eb8b8debe5"
        ),
        .target(
