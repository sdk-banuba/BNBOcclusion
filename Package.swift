...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-211-g9b253c9f0f/BNBOcclusion.zip",
            checksum: "60f1fe5cf8b8c15bd0a580533b166789a1339516afa83e5d4a250c97929fe1e7"
        ),
        .target(
