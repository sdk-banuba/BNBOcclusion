...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-185-gcf256de1ef/BNBOcclusion.zip",
            checksum: "6f06d9d27225c275aa4a0969465a43469761a306b7beb5794e567ad99b3db20c"
        ),
        .target(
