...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-185-gf41e807277/BNBOcclusion.zip",
            checksum: "32f60bd8b6e325f1fd62f968b4b9a5988a7b79d97e9b851eb2bbb17794c2e60d"
        ),
        .target(
