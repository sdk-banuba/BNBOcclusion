...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-183-gf9e3d7354f/BNBOcclusion.zip",
            checksum: "284fabdbf8bf85c9f790f2839510f26049abaf59985b6e1470a15230e44b6251"
        ),
        .target(
