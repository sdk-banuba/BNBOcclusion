...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-187-g0f5dcf5d80/BNBOcclusion.zip",
            checksum: "2937e1249596c4432243a8ae2b19543bb372d40ca79a8fc875e673e32e85dde8"
        ),
        .target(
