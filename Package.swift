...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-130-g1d6e43380/BNBOcclusion.zip",
            checksum: "fcb52a32231fbb5017bdf22e5cb030c8b57022a11385a3fc82f2b640d35957ce"
        ),
        .target(
