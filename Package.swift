...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-186-g71865c20be/BNBOcclusion.zip",
            checksum: "ed67fafe70699c220da72f34a4dded72881171a14bd8ca76ac6fd2f8e9b0e16f"
        ),
        .target(
