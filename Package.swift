...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-199-g2f4e3cf953/BNBOcclusion.zip",
            checksum: "977b12d26292858ee3b6dd383194558e816c2ded4c5e2963b544399d6f82b3c1"
        ),
        .target(
