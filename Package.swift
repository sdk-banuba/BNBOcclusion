...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-180-gd5fc258816/BNBOcclusion.zip",
            checksum: "e19f16307aa9103e9772169d82a841c485525876e52f15dff48918f4350d90a4"
        ),
        .target(
