...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBOcclusion",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-194-gb1629e3e8c/BNBOcclusion.zip",
            checksum: "c78e2b1c90d9df3d32d34d8512aa16e7dc04bf9ad66752b847ee0e256b952853"
        ),
        .target(
